...
function RouterBase(props: { id: string; children: ReactNode }) {
  ...
  return (
    ...
    >
      <Flare.Base className="group w-full bg-video-context-border bg-opacity-30 backdrop-blur-md h-full rounded-2xl transition-colors duration-100 text-video-context-type-main">
        <Flare.Light
          flareSize={400}
