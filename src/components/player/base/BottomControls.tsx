  ...
  return (
    <div className="w-full text-white">
      ...
      <div
        ...
        className="pointer-events-auto z-10 pl-[calc(1rem+env(safe-area-inset-left))] pr-[calc(1rem+env(safe-area-inset-right))] pb-4 mb-[env(safe-area-inset-bottom)] absolute bottom-0 w-full"
      >
