...
export function ProvidersPart(props: {
  ...
  return (
    <div className="space-y-6">
      <Heading1 border>{t("settings.providers.title", "Providers")}</Heading1>
            ...
            >
                  ...
                  {editingId === source.id ? (
                    ...
                    <div className="flex items-center gap-2 group">
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 transition-opacity text-type-dimmed hover:text-white"
              ...
              <div className="flex items-center gap-6 pl-14 md:pl-0">
                ...
                <div className="text-center">
                  ...
                  <div className="font-mono font-medium">
                    {status && status.responseTime !== undefined
